...
def get_json(url, train_date, from_station, to_station, purpose_codes='ADULT'):
    url = url + '?leftTicketDTO.train_date=' + train_date + \
    ...
    req.add_header('Cookie',
                   ...
                   'route=6f50b51faa11b987e576cdb301e545c4; BIGipServerotn=1473839370.50210.0000;'
                   ' fp_ver=4.5.1; RAIL_EXPIRATION=1505522206734; RAIL_DEVICEID=ngfa0xXXc43Aw-'
                   'RdePQiYKNAXLxgF_0NC4u29FDPVr73XbEdk2jAZXdZmGwbMs5tmX28EVf3pqQWywtJRANyU-F1F4'
                   'o1jEN2J8gI5mQVerkJAel9E5ACri_F-7hggwk7zmV0IkRNjiH5CA0RFxBPLTsBkmBvAJ9_;'
                   ' current_captcha_type=C; _jc_save_fromStation=%u90D1%u5DDE%2CZZF; _'
                   'jc_save_toStation=%u5F00%u5C01%2CKFF; _jc_save_fromDate=2017-09-25; '
...
def list_ticket(train_date, from_station, to_station):
    json_result = get_json('https://kyfw.12306.cn/otn/leftTicket/query', train_date, stations_dict.get(from_station),
